...
namespace Utils {
    ...
    public class CreateAndRegisterService : Attribute {
        private Type _serviceType;

        public CreateAndRegisterService(Type type) {
            _serviceType = type;
        }
        ...
        public static IEnumerable<(Type type, Type serviceClass)> GetRegisteredServices() {
            ...
            foreach (var assembly in assemblies) {
                ...
                foreach (var type in types) {
                    var attribute = type.GetCustomAttribute<CreateAndRegisterService>();
